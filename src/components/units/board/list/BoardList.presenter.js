import {
    ...
    BestBoardsWrap,
    BestBoardTop,
    BoardsSec, BoardTd, BoardTh, BoardTr, ButtonArrow,
    ButtonFilled,
    ButtonLike, ButtonOutlined,
    Date,
    DateInput, Pagination, PaginationBox, PaginationSec,
    Profile,
    SearchInput,
    SearchSec,
    TableWrap,
            ...
            <TableWrap>
                <SearchSec>
                    ...
                    <DateInput
                        ...
                        value={`${props.srchDate.startDate} ~ ${props.srchDate.endDate}`}
                        onChange={e => props.onChangeDateInput(e)}
                    />
